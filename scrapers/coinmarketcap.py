...
def scrape_news_topic_9():
    ...
    base_url = "https://coinmarketcap.com/headlines/news/"
    ...
    try:
        ...
        # پیدا کردن اولین لینک خبر
        first_news = soup.select_one("div.sc-4c05d6ef-0 a")
        if not first_news:
        ...
        # تلاش برای پیدا کردن div مقاله با توجه به ساختار جدید
